...
* 👁️ **Lidar Nativo (Raycasting):** Hemos inyectado ganchos en las funciones de intercepción de BSP de Doom (`P_PathTraverse`). La IA dispara láseres para detectar muros directamente desde el motor de colisiones de id Software.
...
**Si eres un loco del bajo nivel, C, WASM o las Redes Neuronales, siéntete libre de FORKEAR el repo y tirar un Pull Request.**

¿Te gusta lo que ves? Todo este código es libre, abierto y directo a las tripas del software.
